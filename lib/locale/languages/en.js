...
export const en = {
  ...
  searchResult: {
    ...
    label: {
      ...
      priceAscOrder: 'Tution Fee from low to high',
      priceDescOrder: 'Tution Fee from high to low',
      ratingAscOrder: 'Rating from  low to high',
      ratingDescOrder: 'Rating from  high to low',
      commentAscOrder: 'Comments from less to more',
      commentDescOrder: 'Comments from more to less',
    },
  },
  profileSetting: {
  ...
  profile: {
    ...
    text: {
      login: 'Login',
      pleaseSignInToViewYourProfile: 'Please sign in to view your profile',
      signUp:'Sign up',
      comments: 'Comments',
  ...
  signUp:{
    ...
    text:{
      ...
      agreement:{
        label:'透過註冊，表示你已經同意appname服務條款及私隱政策。',
      },
    },
  },
  forgotPassword:{
